@echo off 
set imageName="nodexpress"
set containerPort=3000
set dockerHostName="default"
set publicPort=3000
...
:runContainer
    ...
    docker run -di -p %publicPort%:%containerPort% -v /c/Users/Lajt/Code/playground/docker-lajt/node:/src %imageName%
